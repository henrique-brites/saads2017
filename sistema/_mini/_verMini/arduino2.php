...
<div class="container" id="con-colsulta">
	...
	<section>
		...
		if($registros > 0){
			...
			print "$registros Inscritos.        <a href='_impre/impressao.php?btnImrArduino2=Impressao' id='btn_sair'><input type='button' name='btnImprUnity' value='Impressao' class='btn'/></a>";
